function openNav() {
  ...
  function openProductModal(title, desc, price, imgSrc) {
    ...
    var modalContent = `
      ...
      <p>${desc}</p>
      <h3>Ár: ${price} Ft</h3>
      <button onclick="closeProductModal()" style="cursor: pointer; padding:6px; color: white; background-color: black; border-radius: 5px; border: none;">Bezárás</button>
    `;
  ...
  function uploadFile() {
    ...
    if (fileTitle && fileDesc && fileInput && filePrice) {
      ...
      reader.onload = function(e) {
        ...
        // Kattintási esemény hozzáadása a termékkártyához
